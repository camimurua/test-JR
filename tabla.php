<?php
    ...
    $dniElegido = $_POST["dniIngresado"];

    $clientes = "SELECT * FROM clientes WHERE DNI = '$dniElegido'";
?>
    ...
    <h1>Test para lista de clientes:</h1>
        ...
        <div class="container-table">
                ...
                <div class="table-item"> 
                    <a href="modificacion.php?id=<?php echo $card["id"];?>"
                    class="modificar-cliente"> MODIFICAR CLIENTE </a>
                    <a href="eliminar.php?id=<?php echo $card["id"];?>"
                    class="borrar-cliente"> ELIMINAR CLIENTE </a>
                    <a href="index.php" class="modificar-cliente"> VOLVER A INICIO </a>
                </div>
